                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <div class="footer-items">
                                <!-- Footer Title -->
                            <h3 class="footer-title text-uppercase mb-2">ABOUT WORLD ANTIQUE SPACE</h3>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <div class="footer-items">
                                <!-- Footer Title -->
                                <h3 class="footer-title text-uppercase mb-2">PORTFOLIO</h3>
                                <ul>

                                <?php
                                $q="SELECT * FROM  portfolio ORDER BY id DESC LIMIT 5";
                                $r123 = mysqli_query($con,$q);
                                ...
                                print "
                                <li class='py-2'><a class='text-black-50' href='portfolio.php?id=$id'>$port_title</a></li>
                                ";
                                }
                                ?>
