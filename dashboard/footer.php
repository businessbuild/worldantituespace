    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">Copyright @<script>document.write(new Date().getFullYear())</script> World Antique Space. All Rights Reserved | Site map
                </div>
                <div class="col-sm-6">
                    <div class="text-sm-end d-none d-sm-block">
                        Design & Develop by World Antique Space
                    </div>
                </div>
            </div>
        </div>
