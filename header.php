...
?>
    <!-- Title  -->
    <title>WORLD - <?php print $site_title ?></title>
    ...
    <div id="preloader">
        ...
        <div id="digimax-preloader" class="digimax-preloader">
            ...
            <div class="preloader-animation">
                ...
                <!-- Loader -->
                <div class="loader">
                    <span data-text-preloader="V" class="animated-letters">S</span>
                    <span data-text-preloader="O" class="animated-letters">P</span>
                    <span data-text-preloader="G" class="animated-letters">A</span>
                    <span data-text-preloader="U" class="animated-letters">C</span>
